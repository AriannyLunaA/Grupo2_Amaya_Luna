...
class MsNotificacionApplicationTests {
    ...
    void verificarCorreoDestino() {
        Notificacion notificacion = notificacionService.buscarPorId(1);
    ...
    void verificarTipoNotificacionValido() {
        Notificacion notificacion = notificacionService.buscarPorId(1);
