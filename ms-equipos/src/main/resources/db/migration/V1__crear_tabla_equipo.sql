...
VALUES (1, 'Notebook', 'HP', 'Victus 15', 'Intel Core i5', '16GB', '512GB SSD M.2', 'NVIDIA GTX 1650', 'SN-987654321', 'Raya leve en la tapa');

INSERT INTO equipo (id_persona, tipo, marca, modelo, procesador, memoria_ram, almacenamiento, tarjeta_grafica, numero_serie, observaciones_fisicas)
VALUES (2, 'Consola', 'Sony', 'PlayStation 5', 'AMD Ryzen Zen 2', '16GB', '825GB SSD', 'AMD Radeon RDNA 2', 'SN-112233445', 'Mucho polvo en ventiladores');